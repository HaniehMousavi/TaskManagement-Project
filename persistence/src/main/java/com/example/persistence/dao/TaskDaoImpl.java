...
public class TaskDaoImpl implements TaskDao {
    ...
    @Override
    public Boolean update(Long id, ReqTaskUpdateDTO entity) {
    ...
    @Override
    public List<ResTaskGetListDTO> getListTasks(Long id) throws CustomException {
    ...
    @Override
    public ResTaskGetOneDTO getOneByIdAsDTO(Long id) throws CustomException {
